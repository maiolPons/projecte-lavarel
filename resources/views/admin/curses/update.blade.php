...
@section('titol','modificar Cursa')
@section('content')
<div class="container">
    <form action="{{route('actualitzarCurses')}}" enctype="multipart/form-data" method="post">
        @csrf
