...
<div class="container">
    <form action="<?php echo e(route('GuardarInsurers')); ?>" enctype="multipart/form-data" method="post">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row pt-4">
                    <button class="btn btn-primary col-md-2">Afegir Aseguradora</button>
                </div>
            </div>
        </div>
    </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProjecteLaravel\project\resources\views/admin/insurers/create.blade.php ENDPATH**/ ?>