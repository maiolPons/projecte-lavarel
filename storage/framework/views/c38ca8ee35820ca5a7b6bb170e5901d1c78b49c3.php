...
<?php $__env->startSection('titol','Modificar Sponsors'); ?>
<?php $__env->startSection('content'); ?>
<div class="container">
    <form action="<?php echo e(route('actualitzarSponsors')); ?>" enctype="multipart/form-data" method="post">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-8offset-2">
                ...
                <div class="row mb-3">
                    ...
                    <input id="name_sponsor" 
                        type="text" 
                        value="<?php echo e($sponsors->name_sponsor); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-3">
                    ...
                    <input id="CIF_sponsor" 
                        type="text" 
                        value="<?php echo e($sponsors->CIF_sponsor); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-3">
                    ...
                    <input id="sponsor_address" 
                        type="text"
                        value="<?php echo e($sponsors->sponsor_address); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-3">
                    ...
                    <input id="home_page" 
                        type="text" 
                        value="<?php echo e($sponsors->home_page); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProjecteLaravel\project\resources\views/admin/sponsors/update.blade.php ENDPATH**/ ?>