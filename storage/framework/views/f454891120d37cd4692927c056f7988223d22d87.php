            ...
            <div class="col-12">
                ...
                <nav class="mainNavbar navbar navbar-light bg-light">
                    <a class="navbar-brand" href="/">
                        <img src="<?php echo e(url('/images/logo.png')); ?>" width="40" height="40" class="d-inline-block " alt="logo">
                        <span class="title">Cycl40K</span>
                        <img src="<?php echo e(url('/images/white-scars.svg')); ?>" width="40" height="40" class="d-inline-block " alt="logo">
