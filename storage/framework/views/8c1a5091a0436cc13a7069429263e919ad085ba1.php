...
<div class="row justify-content-center">
    <div class="col-8">
        <div class="row">
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <a href="<?php echo e(route('crearParticipant', $lastOnes[0]->id)); ?>">
                            <div class="frameSlider frame"
                                style="background-image: url('/storage/<?php echo e($lastOnes[0]->promotion_img); ?>')"></div>
                    ...
                    <?php if(count($lastOnes)==2): ?>
                    <div class="item">
                        <a href="<?php echo e(route('crearParticipant', $lastOnes[1]->id)); ?>">
                            <div class="frameSlider frame"
                                style="background-image: url('/storage/<?php echo e($lastOnes[1]->promotion_img); ?>')"></div>
                            <div class="carousel-caption">
                    ...
                    <?php if(count($lastOnes)==3): ?>
                    <div class="item">
                        <a href="<?php echo e(route('crearParticipant', $lastOnes[2]->id)); ?>">
                            <div class="frameSlider frame"
                                style="background-image: url('/storage/<?php echo e($lastOnes[2]->promotion_img); ?>')"></div>
                            <div class="carousel-caption">
            ...
            <div class="row">
                <h3 class="h3-title">Dona un cop d'ull a les curses que oferim <img src="<?php echo e(url('/images/yarik.png')); ?>"
        ...
        <div class="row">
            ...
            <a style="background-image: url('/storage/<?php echo e($cursa->promotion_img); ?>')" class="col-3 item-main"
                href="<?php echo e(route('crearParticipant', $cursa->id)); ?>">

                <div class="item-text">
                    <span>Kilometres: <?php echo e($cursa->kms); ?></span>

                    <span>Data: <?php echo e($cursa->date_start); ?></span>
                </div>
